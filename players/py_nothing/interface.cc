...
PyObject* a3;
  if (!PyArg_ParseTuple(args, "OOOO", &a0, &a1, &a2, &a3)) {
    ...
    try {
return cxx2lang<PyObject*, int>(api_mur_compute_stock_loss(lang2cxx<PyObject*, mur_position>(a0), lang2cxx<PyObject*, mur_position>(a1), lang2cxx<PyObject*, int>(a2), lang2cxx<PyObject*, int>(a3)));
  } catch (...) { return NULL; }
}
