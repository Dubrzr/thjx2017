...
template <>
PyObject* cxx2lang<PyObject*, mur_position>(mur_position in)
{
...
template <>
mur_position lang2cxx<PyObject*, mur_position>(PyObject* in)
{
...
template <>
PyObject* cxx2lang<PyObject*, mur_role>(mur_role in)
{
...
template <>
mur_role lang2cxx<PyObject*, mur_role>(PyObject* in)
{
...
template <>
PyObject* cxx2lang<PyObject*, nose_position>(nose_position in)
{
...
template <>
nose_position lang2cxx<PyObject*, nose_position>(PyObject* in)
{
  nose_position out;
  PyObject* i;
...
template <>
PyObject* cxx2lang<PyObject*, mur_losses>(mur_losses in)
{
  PyObject* tuple = PyTuple_New(2);
  PyTuple_SET_ITEM(tuple, 0, (cxx2lang<PyObject*, int>(in.attacker)));
  PyTuple_SET_ITEM(tuple, 1, (cxx2lang<PyObject*, int>(in.defender)));
  return tuple;
}

template <>
mur_losses lang2cxx<PyObject*, mur_losses>(PyObject* in)
{
  mur_losses out;
  PyObject* i;
  i = PyTuple_GetItem(in, 0);
  if (i == NULL) throw 42;
  out.attacker = lang2cxx<PyObject*, int>(i);
  i = PyTuple_GetItem(in, 1);
  if (i == NULL) throw 42;
  out.defender = lang2cxx<PyObject*, int>(i);
  return out;
}
...
PyObject* a1;
  if (!PyArg_ParseTuple(args, "OO", &a0, &a1)) {
    ...
    try {
return cxx2lang<PyObject*, action_error>(api_play_mur(lang2cxx<PyObject*, mur_position>(a0), lang2cxx<PyObject*, int>(a1)));
  } catch (...) { return NULL; }
}
...
PyObject* a1;
  if (!PyArg_ParseTuple(args, "OO", &a0, &a1)) {
    ...
    try {
return cxx2lang<PyObject*, action_error>(api_play_nose(lang2cxx<PyObject*, int>(a0), lang2cxx<PyObject*, int>(a1)));
  } catch (...) { return NULL; }
}
...
PyObject* a0;
  if (!PyArg_ParseTuple(args, "O", &a0)) {
    ...
    try {
return cxx2lang<PyObject*, mur_role>(api_mur_role_of_player(lang2cxx<PyObject*, int>(a0)));
  } catch (...) { return NULL; }
}
...
PyObject* a0;
  if (!PyArg_ParseTuple(args, "O", &a0)) {
    ...
    try {
return cxx2lang<PyObject*, int>(api_mur_stock(lang2cxx<PyObject*, int>(a0)));
  } catch (...) { return NULL; }
}
...
PyObject* a3;
  if (!PyArg_ParseTuple(args, "OOOO", &a0, &a1, &a2, &a3)) {
    ...
    try {
return cxx2lang<PyObject*, mur_losses>(api_mur_compute_stock_loss(lang2cxx<PyObject*, mur_position>(a0), lang2cxx<PyObject*, mur_position>(a1), lang2cxx<PyObject*, int>(a2), lang2cxx<PyObject*, int>(a3)));
  } catch (...) { return NULL; }
}
...
PyObject* a0;
  if (!PyArg_ParseTuple(args, "O", &a0)) {
    ...
    try {
return cxx2lang<PyObject*, mur_position>(api_mur_last_pos(lang2cxx<PyObject*, int>(a0)));
  } catch (...) { return NULL; }
}
...
PyObject* a0;
  if (!PyArg_ParseTuple(args, "O", &a0)) {
    ...
    try {
return cxx2lang<PyObject*, int>(api_mur_last_used_stock(lang2cxx<PyObject*, int>(a0)));
  } catch (...) { return NULL; }
}
...
PyObject* a1;
  if (!PyArg_ParseTuple(args, "OO", &a0, &a1)) {
    ...
    try {
return cxx2lang<PyObject*, int>(api_nose_squares_taken(lang2cxx<PyObject*, int>(a0), lang2cxx<PyObject*, int>(a1)));
  } catch (...) { return NULL; }
}
...
static PyObject* p_afficher_mur_losses(PyObject* self, PyObject* args)
{
  (void)self;
PyObject* a0;
  if (!PyArg_ParseTuple(args, "O", &a0)) {
    ...
    try {
api_afficher_mur_losses(lang2cxx<PyObject*, mur_losses>(a0));
  Py_INCREF(Py_None);
  return Py_None;
  } catch (...) { return NULL; }
}
...
static PyMethodDef api_callback[] = {
  {"play_mur", p_play_mur, METH_VARARGS, "play_mur"},  {"play_nose", p_play_nose, METH_VARARGS, "play_nose"},  {"me", p_me, METH_VARARGS, "me"},  {"opponent", p_opponent, METH_VARARGS, "opponent"},  {"score", p_score, METH_VARARGS, "score"},  {"mur_role_of_player", p_mur_role_of_player, METH_VARARGS, "mur_role_of_player"},  {"mur_stock", p_mur_stock, METH_VARARGS, "mur_stock"},  {"mur_compute_stock_loss", p_mur_compute_stock_loss, METH_VARARGS, "mur_compute_stock_loss"},  {"mur_last_pos", p_mur_last_pos, METH_VARARGS, "mur_last_pos"},  {"mur_last_used_stock", p_mur_last_used_stock, METH_VARARGS, "mur_last_used_stock"},  {"nose_last_played_square", p_nose_last_played_square, METH_VARARGS, "nose_last_played_square"},  {"nose_remaining_squares", p_nose_remaining_squares, METH_VARARGS, "nose_remaining_squares"},  {"nose_squares_to_take", p_nose_squares_to_take, METH_VARARGS, "nose_squares_to_take"},  {"nose_squares_taken", p_nose_squares_taken, METH_VARARGS, "nose_squares_taken"},  {"afficher_mur_position", p_afficher_mur_position, METH_VARARGS, "afficher_mur_position"},  {"afficher_mur_role", p_afficher_mur_role, METH_VARARGS, "afficher_mur_role"},  {"afficher_action_error", p_afficher_action_error, METH_VARARGS, "afficher_action_error"},  {"afficher_nose_position", p_afficher_nose_position, METH_VARARGS, "afficher_nose_position"},  {"afficher_mur_losses", p_afficher_mur_losses, METH_VARARGS, "afficher_mur_losses"},  {NULL, NULL, 0, NULL}
};
