...
HASKELL_CFLAGS	= -O2 -I`$(GHC) --afficher-libdir`/include -std=c++11
...
cmd_hsc2hs		= $(HSC2HS) $< -o $@
cmd_ghc			= $(GHC) -pgml $(CXX) -O9 -dynamic --make -shared -fPIC -L`$(GHC) --afficher-libdir` -lHSrts-ghc`$(GHC) --numeric-version` $(filter %.hs %.o %.a,$^) -o $@
