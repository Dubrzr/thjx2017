...
extern "C" int api_mur_compute_stock_loss(mur_position your_position, mur_position their_position, int your_amount, int their_amount)
{
  return api->mur_compute_stock_loss(your_position, their_position, your_amount, their_amount);
}
...
{
  switch (v) {
  case ATTACKER: os << "ATTACKER"; break;
  case DEFENDER: os << "DEFENDER"; break;
  }
  return os;
}
